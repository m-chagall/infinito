  ...
  return (
    <>
      <footer className="bg-white px-2 py-4 rounded-lg md:px-6 md:py-8 dark:bg-gray-800">
        ...
        {/* <span className="block text-xs text-center text-gray-400 sm:text-sm sm:text-center dark:text-gray-400">사업자등록번호: 000-00-00000  <span className="hidden sm:inline">| </span> <br className="sm:hidden"/>통신판매업신고번호:제0000-서울동작-0000호 <a href="/" className="hover:underline">[정보조회]</a></span> */}
